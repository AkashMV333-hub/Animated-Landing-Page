    ...
    <div className='w-[calc(100vw - 15px)] bgcolor flex justify-center items-center'>
        <div className=' grid grid-rows-3 rotate-45 gap-3 p-25'>
            <div className=' w-[900px] flex justify-center items-center'>
                <div className='w-[300px] h-[300px] flex justify-center items-center bg-black rounded-2xl -mr-4'>
            ...
            <div className='grid grid-cols-3 w-[900px] gap-8'>
                <div className='w-[300px] h-[300px] flex justify-center items-center bg-black rounded-2xl'>
                ...
                <div className='w-[300px] h-[300px] flex justify-center items-center bg-white rounded-2xl'>
